...
public class SeicentoUserAuthenticator implements Authenticator<CredentialsUsernamePassword, CredentialsUsernamePassword>
 {
	 ...
	 *
	 */
	public SeicentoUserAuthenticator (
			...
			final CredentialsUsernamePassword credentials) throws AuthenticationFailedException
	{
		...
		final SeicentoUserXmlHandler hdl = new SeicentoUserXmlHandler();
		if (!hdl.isAuthenticated(credentials)) {
