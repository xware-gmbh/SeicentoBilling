...
public class CompanyTabView extends XdevView {
	...
	private void initUI() {
		...
		this.lblCmpVatcode.setDescription("Wird nicht mehr verwendet. UID benutzen");
		...
		this.lblCmpEndpointDocCre.setValue("Endpoint Beleg Kredi");
	...
	private XdevLabel lblCmpName, lblCmpAddress, lblCmpZip, lblCmpPlace, lblCmpVatcode, lblCmpCurrency, lblCmpUid,
			...
			lblCmpEndpointDoc, lblCmpEndpointCre, lblCmpEndpointDocCre, lblCmpAbaUser, lblCmpAbaMandator, lblCmpAbaMaxDays;
	...
	private XdevTextField txtCmpName, txtCmpAddress, txtCmpZip, txtCmpPlace, txtCmpVatcode, txtCmpCurrency, txtCmpUid,
			...
			txtCmpEndpointCre, txtCmpEndpointCreDoc, txtCmpAbaUser, txtCmpAbaMandator, txtCmpAbaMaxDays;
