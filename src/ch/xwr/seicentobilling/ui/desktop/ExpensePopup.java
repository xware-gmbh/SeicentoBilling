...
public class ExpensePopup extends XdevView {
	...
	private void setupUploader(final RowImage bean) {
		...
		this.upload.addSucceededListener(new Upload.SucceededListener() {
			...
			public void uploadSucceeded(final SucceededEvent event) {
        	    ...
        	    if (ExpensePopup.this.urcv.getFiup().length() >  (ExpensePopup.this.urcv.getMaxImageSize() * 4)) {
	...
	private void initUI() {
		...
		this.lblExpCostAccountCompany = new XdevLabel();
		...
		this.cmbCostAccountCompany = new XdevComboBox<>();
		...
		this.lblExpCostAccountCompany.setValue("Kostenstelle Firma");
		...
		this.fieldGroup.bind(this.cmbCostAccountCompany, Expense_.costAccountCompany.getName());
		...
		this.form.addComponent(this.lblExpFlagCostAccount, 2, 5);
		this.chkExpFlagCostAccount.setWidth(100, Unit.PERCENTAGE);
		this.chkExpFlagCostAccount.setHeight(-1, Unit.PIXELS);
		this.form.addComponent(this.chkExpFlagCostAccount, 3, 5);
		...
		this.lblExpCostAccountCompany.setSizeUndefined();
		this.form.addComponent(this.lblExpCostAccountCompany, 2, 6);
		...
		this.cmbCostAccountCompany.setSizeUndefined();
		this.form.addComponent(this.cmbCostAccountCompany, 3, 6);
		...
		this.chkExpFlagCostAccount.addValueChangeListener(event -> this.chkExpFlagCostAccount_valueChange(event));
	...
	private XdevLabel label, label3, lblPeriode, lblExpBooked, lblExpDate, lblExpText, lblExpAmount, lblVat, lblProject,
			lblExpAccount, lblExpFlagCostAccount, lblExpFlagGeneric, lblExpCostAccountCompany, lblExpUnit, lblExpQuantity,
			lblExpState, label2;
	...
	private XdevComboBox<CostAccount> cmbCostAccountCompany;
