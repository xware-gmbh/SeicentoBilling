...
import ch.xwr.seicentobilling.ui.desktop.code.LabelDefinitionTabView;
...
//		}
	 ...
	 * @eventHandlerDelegate Do NOT delete, used by UI designer!
	 */
	private void menuLabelDef_menuSelected(final MenuBar.MenuItem selectedItem) {
		loadTab(LabelDefinitionTabView.class, selectedItem.getText());
	}
	...
	private void initUI() {
		...
		this.mnuSeperator3 = this.mnuAddon.addSeparator();
		this.menuLabelDef = this.mnuAddon.addItem("Labels", null);
		...
		this.menuLabelDef.setCommand(selectedItem -> this.menuLabelDef_menuSelected(selectedItem));
	...
	private XdevMenuItem mnuOperation, mnuOrder, mnuItem, mnuCustomer, mnuSeperator, mnuOrderGenerate, mnuExpense,
			...
			menuCostAccount, menuVat, menuCity, mnuSeperator3, menuLabelDef, mnuOption, mnuCompany, mnuObject, menuItemUser,
			menuItemProfile, menuItemUsrInfo, mnuSeperator2, menuItemLogout;
