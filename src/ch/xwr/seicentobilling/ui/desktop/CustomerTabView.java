...
//		this.tableActivity.addItems(bean.getActivities());
	...
	private XdevButton cmdNew, cmdDelete, cmdReload, cmdReport, cmdInfo, cmdNewAddress, cmdDeleteAddress, cmdEditAddress,
			cmdReloadAddress, cmdInfoAddress, cmdNewCustomerLink, cmdDeleteCustomerLink, cmdEditCustomerLink,
			cmdReloadCustomerLink, cmdInfoCustomerLink, cmdNewActivity, cmdDeleteActivity, cmdEditActivity,
			cmdReloadActivity, cmdInfoActivity, cmdNewRelation, cmdDeleteRelation, cmdSave, cmdReset;
