...
//		this.tableActivity.addItems(bean.getActivities());
	...
	private XdevGridLayout form, gridLayoutFlags, gridLayoutAddress, gridLayoutListActivity, gridLayoutRelation,
			gridLayoutListRef, gridLayoutContact;
	...
	private XdevHorizontalLayout actionLayout, horizontalLayoutAddress, horizontalLayoutLink, horizontalLayout3,
			horizontalLayout2, horizontalLayoutCity, horizontalLayout;
	...
	private XdevComboBox<?> cbxAccountBillingType, cbxAccountBillingReports, cbxAccountType, cbxAccountSalutation, cbxState;
	private XdevTable<Project> tableProject;
	private XdevTable<Order> tableOrder;
	private XdevTextField txtAccountManager, txtCusInfo, txtExtRef1, txtExtRef2, txtCusNumber, txtCusCompany, txtCusName,
			txtCusFirstName, txtCusAddress, txtZip;
	private XdevTwinColSelect<LabelDefinition> twinColSelect;
	private XdevTable<ContactRelation> tableRelation;
	private XdevLabel lblAccountManager, lblCusInfo, lblPaymentCondition, lblBillingTarget, lblBillingReports, lblLabels,
			lblExtRef1, lblExtRef2, lblCusNumber, lblType, lblAnrede, lblCusCompany, lblCusName, lblCusFirstName, lblCity,
			lblCountry, lblBirthdate, lblCusState;
