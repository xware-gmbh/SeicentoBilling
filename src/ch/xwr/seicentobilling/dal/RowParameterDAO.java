...
public class RowParameterDAO extends JPADAO<RowParameter, Long> {
	...
	{
		final List<RowParameter> li = findByObject(root, groups, subgroup, key);
		if (li.size() == 0) {
			return null;
		}
		return li.get(0);
	 ...
	 */
	public List<RowParameter> findByObject(final RowObject rowObj, final String groups, final String subgroup, final String key) {
