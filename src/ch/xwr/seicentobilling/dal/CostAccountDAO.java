...
public class CostAccountDAO extends JPADAO<CostAccount, Long> {
	 ...
	 * @queryMethod Do not edit, method is generated by editor!
	 */
	public List<CostAccount> findAllActiveCompanyCstOrderByName() {
		final EntityManager entityManager = em();
		...
		criteriaQuery.where(
				criteriaBuilder.and(criteriaBuilder.equal(root.get(CostAccount_.csaState), criteriaBuilder.literal(1)),
						criteriaBuilder.equal(root.get(CostAccount_.csaFlagCompany), criteriaBuilder.literal(1))));
