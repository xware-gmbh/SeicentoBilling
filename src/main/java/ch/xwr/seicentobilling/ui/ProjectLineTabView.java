...
public class ProjectLineTabView extends VerticalLayout
{
	...
	/**
	 * Event handler delegate method for the {@link Anchor} {@link #cmdExport}.
	 *
	 * @see ComponentEventListener#onComponentEvent(ComponentEvent)
	 * @eventHandlerDelegate Do NOT delete, used by UI designer!
	 */
	private void cmdExport_onAttach(final AttachEvent event)
	{
	}
	...
	private void initUI()
	{
		...
		this.cmdExport.addAttachListener(this::cmdExport_onAttach);
